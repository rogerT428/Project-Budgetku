...
public class FruitListActivity extends AppCompatActivity {
    ...
    private List<Buah> getBuahList() {
        ...
        list.add(new Buah("Jeruk", "🍊",
                "Asia Selatan", "Manis-asam segar",
        ...
        list.add(new Buah("Pisang", "🍌",
                "Asia Tenggara", "Manis lembut",
        ...
        list.add(new Buah("Mangga", "🥭",
                "Asia Selatan", "Manis harum",
        ...
        list.add(new Buah("Anggur", "🍇",
                "Asia Barat", "Manis-asam",
        ...
        list.add(new Buah("Stroberi", "🍓",
                "Eropa & Amerika", "Manis-asam segar",
        ...
        list.add(new Buah("Nanas", "🍍",
                "Amerika Selatan", "Manis-asam tropik",
        ...
        list.add(new Buah("Melon", "🍈",
                "Asia & Afrika", "Manis lembut",
        ...
        list.add(new Buah("Pepaya", "🧡",
                "Amerika Tengah", "Manis lembut",
        ...
        list.add(new Buah("Durian", "🟡",
                "Asia Tenggara", "Manis-pahit kuat",
        ...
        list.add(new Buah("Apel", "🍎",
                "Asia Tengah", "Manis-asam renyah",
        ...
        list.add(new Buah("Pir", "🍐",
                "Asia & Eropa", "Manis lembut",
        ...
        list.add(new Buah("Ceri", "🍒",
                "Eropa & Amerika", "Manis-asam",
        ...
        list.add(new Buah("Persik", "🍑",
                "Cina", "Manis-asam harum",
        ...
        list.add(new Buah("Kelapa", "🥥",
                "Asia Tropis", "Manis segar",
        ...
        list.add(new Buah("Kiwi", "🥝",
                "Cina & Selandia Baru", "Asam-manis segar",
        ...
        list.add(new Buah("Lemon", "🍋",
                "Asia Selatan", "Asam segar",
        ...
        list.add(new Buah("Alpukat", "🥑",
                "Amerika Tengah", "Gurih lembut",
        ...
        list.add(new Buah("Blueberry", "🫐",
                "Amerika Utara", "Manis-asam",
        ...
        list.add(new Buah("Delima", "❤️",
                "Persia & Asia Barat", "Manis-asam",
        ...
        list.add(new Buah("Rambutan", "🔴",
                "Asia Tenggara", "Manis-asam",
        ...
        list.add(new Buah("Manggis", "🟤",
                "Asia Tenggara", "Manis-asam menyegarkan",
        ...
        list.add(new Buah("Salak", "🟫",
                "Indonesia", "Manis-asam sepat",
        ...
        list.add(new Buah("Jambu Biji", "🟢",
                "Amerika Tropis", "Manis-asam",
        ...
        list.add(new Buah("Belimbing", "⭐",
                "Asia Tropis", "Asam-manis segar",
        ...
        list.add(new Buah("Markisa", "💜",
                "Amerika Selatan", "Asam-manis harum",
        ...
        list.add(new Buah("Sirsak", "💚",
                "Amerika Tengah", "Manis-asam creamy",
        ...
        list.add(new Buah("Longan", "⚪",
                "Asia Selatan", "Manis lembut",
        ...
        list.add(new Buah("Leci", "🔵",
                "Cina Selatan", "Manis harum",
        ...
        list.add(new Buah("Kurma", "🟠",
                "Timur Tengah", "Manis karamel",
